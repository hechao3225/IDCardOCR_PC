...
QT_MOC_LITERAL(4, 28, 11), // "progressVal"
QT_MOC_LITERAL(5, 40, 8), // "infoType"
QT_MOC_LITERAL(6, 49, 7), // "ocrDone"
QT_MOC_LITERAL(7, 57, 19) // "startTesseractError"

    },
    "OCRThread\0newOCRResult\0\0str\0progressVal\0"
    "infoType\0ocrDone\0startTesseractError"
};
...
void OCRThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newOCRResult((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (OCRThread::*_t)(const QString & , int , int );
...
// SIGNAL 0
void OCRThread::newOCRResult(const QString & _t1, int _t2, int _t3)
{
